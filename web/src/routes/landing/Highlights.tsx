    ...
    <section id="highlights" className="py-20 sm:py-28">
      <Container>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2">
            ...
            <GlassPanel className="flex h-full flex-col justify-between gap-8 p-8">
              ...
              <div>
                ...
                <p className="mt-2 font-display text-2xl font-semibold text-white sm:text-3xl">
                  {config ? formatEventDate(config.eventDate) : "Loading date"}
                </p>
                <p className="mt-2 flex items-center gap-2 text-sm text-white/70">
                  <MapPin size={16} /> {config?.venue ?? "Venue announced soon"}
                </p>
              </div>
            </GlassPanel>
          </motion.div>
          ...
          <motion.div {...REVEAL}>
            <GlassPanel className="flex h-full flex-col justify-between gap-6 p-6">
              ...
              <div>
                ...
                <p className="mt-1 font-display text-2xl font-semibold text-white">
                  {config ? formatPriceInPaise(config.priceInPaise) : "—"}
                </p>
              </div>
            </GlassPanel>
          </motion.div>
